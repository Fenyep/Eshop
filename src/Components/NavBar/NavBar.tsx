import {FaHome, FaListUl, FaBookmark, FaQuestionCircle } from 'react-icons/fa'
        ...
        <header className="bg-white">
          <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1 items-center">
              <a href="#" className="-m-1.5 p-1.5 mr-1">
                <span className="sr-only">Your Company</span>
                <img className="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
              </a>
              <span className="text-black text-lg font-semibold">EShop</span>
            </div>
            ...
            <div className="hidden lg:flex lg:gap-x-12">
...

              {
                [{
                  ...
                  label: "Categories", link: '/categories', icon: <FaListUl />
                }, {
                  label: "Produits", link: '/products', icon: <BsGrid3X3GapFill />
                }, {
                  label: "Stocks", link: '/stocks', icon: <FaBookmark />
                }, {
                  label: "A Propos", link: '/about', icon: <FaQuestionCircle />
                }].map(elmt => (
                  <div className='flex items-center text-md'>
                    <span className='text-black mr-[.5rem]'>
                      {elmt.icon}
                    </span>
                    <a href={`${elmt.link}`} className="font-medium leading-6 text-gray-900">{elmt.label}</a>
                  </div>
                ))
              }
            </div>
            {/* <div className="hidden items-center lg:flex lg:flex-1 lg:justify-end">
              <a href="#" className="text-md font-semibold leading-6 text-gray-900 mr-3">Log in</a>
            ...
            <div className="hidden items-center lg:flex lg:flex-1 lg:justify-end">
              <button className='text-xl mr-2 text-gray-500'>
                <GrNotification />
              </button>
              <button className='flex items-center'>
                <div className='w-[2.5em] h-[2.5em] bg-red-500 rounded-full mr-2' />
                <div className='text-gray-500 text-md'>{currentUser?.name}</div>
              </button>
            </div>
